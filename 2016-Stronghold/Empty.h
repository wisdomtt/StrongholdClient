...
//        NSString* path = [NSString stringWithFormat:@"/Users/CurtisMason/Desktop/Scouting/All/Documentscopy/%@", title];
...
//    
//    
//    NSArray* Items = [self scanPath:@"/Users/CurtisMason/Desktop/Scouting/All/Documentscopy/"];
//    while(true){
